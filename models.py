...
class Card():
    def __init__(self, uid_from_set, lang, name, power, keywords, effect, quote, image_path, filename, cardset = "", use_3d_effect = 0, version = 1): 
    ...
    def toCSVLine(self) -> str:
        return f"{self.uid_from_set},{self.lang},{self.name},{self.power},{self.keywords},{self.effect},{self.quote},{self.image_path},{self.filename},{self.cardset},{self.use_3d_effect},{self.cropped_final_card_base64},{self.final_card_base_64},{self.artwork_base64},{self.version},\n"
